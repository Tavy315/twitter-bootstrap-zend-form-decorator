 ...
 * @since   11.11.2016
 */
class FormElements extends \Zend_Form_Decorator_FormElements
{
    /**
        ...
        foreach ($form as $item) {
            ...
            if ($item instanceof \Zend_Form_Element) {
                ...
                foreach ($displayGroups as $group) {
                    ...
                    if ($element) {
                        // Element belongs to display group; only render in that context.
                        continue 2;
                    }
                }
            ...
            if (($item instanceof \Zend_Form_Element_File)
                || (($item instanceof \Zend_Form) && (\Zend_Form::ENCTYPE_MULTIPART == $item->getEnctype()))
                || (($item instanceof \Zend_Form_DisplayGroup) && (\Zend_Form::ENCTYPE_MULTIPART == $item->getAttrib('enctype')))
            ) {
